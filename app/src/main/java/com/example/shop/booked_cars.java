...
public class booked_cars extends AppCompatActivity implements View.OnClickListener {
    ...
    public void UpdateTable(){
        Cursor cursor = database.query(DBHelper.TABLE_BOOKED, null, null, null, null, null, null);
        k = 0;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            default:
                ...
                int index = 0;
                Cursor cursorUpdater = database.query(DBHelper.TABLE_BOOKED, null, null, null, null, null, null);
